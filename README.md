# Flord AI
#### Умный ИИ-ассистент для Windows 10/11

## 🚀 Скачать

👉 **Последняя версия:** v0.0.3

📦 **Скачать приложение:**
https://github.com/Jurom4ik/FlordAI/releases/tag/v0.0.3

или сразу `.exe`:
https://github.com/Jurom4ik/FlordAI/releases/download/v0.0.3/FlordAI.exe

---

## 🆕 v0.0.3 - Security & Fixes Update

### 🔒 Система безопасности:
- ✅ **Система подтверждения действий ИИ** - анализ кода на опасность перед выполнением
- ✅ **5 уровней опасности** - SAFE, CAUTION, WARNING, DANGER, CRITICAL
- ✅ **Защита от случайных команд** - блокировка опасных операций

### 🐛 Исправленные баги:
- ✅ **Фикс проверки API ключей** - теперь правильно переключает провайдера перед проверкой
- ✅ **Groq, OpenRouter, Gemini** - все провайдеры работают корректно

### 🎨 Улучшения:
- ✅ **Официальная иконка** - `Flord.ico` добавлена в приложение
- ✅ **Улучшенная стабильность** - убраны нестабильные компоненты

### ❌ Удалено:
- ❌ **Telegram бот** - убран из-за нестабильной работы
...
- **Система подтверждения действий** - защита от случайного выполнения опасных команд
